      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-8 items-center md:grid md:grid-cols-[2fr_1fr_1fr] md:gap-8 md:items-start">
          ...
          <div className="flex flex-col gap-6 text-center md:text-left">
            <span className="font-sans text-sm font-medium text-[var(--text-primary)] tracking-[4px]">
              MIDNIGHT
            </span>
            <p className="font-sans text-[13px] font-light text-[var(--text-muted)] leading-relaxed max-w-[240px] mx-auto md:mx-0">
              ...
              <br />
              Limited runs. Precision fused.
            </p>
          </div>

          {/* Center: Product Lineup - positioned towards center */}
          <div className="flex flex-col gap-4 text-center md:text-left">
            <span className="font-mono text-[10px] text-[var(--text-subtle)] tracking-[3px]">
              PRODUCT.LINEUP
            </span>
          ...
          <div className="flex flex-col gap-4 text-center md:text-right md:items-end">
            ...
            <a href="#" className="font-mono text-xs text-[var(--text-muted)] tracking-[2px] hover:text-[var(--text-primary)] transition-colors">
              INSTAGRAM
            </a>
            <a href="#" className="font-mono text-xs text-[var(--text-muted)] tracking-[2px] hover:text-[var(--text-primary)] transition-colors">
              TWITTER/X
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className="font-mono text-[10px] text-[var(--text-subtle)] tracking-[2px]">
            © 2025 MIDNIGHT
          </span>
          <span className="font-mono text-xs font-medium text-[var(--text-primary)] tracking-[2px]">
            midnight00.com
          </span>
        </div>
      </div>
