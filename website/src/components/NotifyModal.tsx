      ...
      <div className="relative w-full max-w-md bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-lg p-8 md:p-10">
        ...
        {status === 'success' ? (
          <div className="text-center py-4">
            ...
            <h3 className="font-sans text-2xl font-light text-[var(--text-primary)] mb-3">
              You're on the list
            </h3>
            <p className="font-sans text-base text-[var(--text-muted)] mb-6">
              We'll notify you when MODEL 00:00 launches.
            </p>
            <button
              onClick={onClose}
          ...
          <>
            <div className="text-center mb-8">
              <span className="font-mono text-xs text-[var(--text-muted)] tracking-[3px]">
                MODEL 00:00
              </span>
              <h3 className="font-sans text-2xl md:text-3xl font-light text-[var(--text-primary)] mt-3 mb-2">
                Get Notified
              </h3>
            ...
            <p className="mt-6 text-center font-sans text-xs text-[var(--text-subtle)]">
