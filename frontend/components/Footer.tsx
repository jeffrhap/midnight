      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-8 items-center md:grid md:grid-cols-[2fr_1fr_1fr] md:gap-8 md:items-start">
          ...
          <div className="flex flex-col gap-6 text-center md:text-left">
            ...
            <p className="font-sans text-[13px] font-light text-[var(--text-muted)] leading-relaxed max-w-[240px] mx-auto md:mx-0 whitespace-pre-line">
              {t("footer.tagline")}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 text-center md:text-left">
            <span className="font-mono text-[10px] text-[var(--text-subtle)] tracking-[3px]">{t("footer.productLineup")}</span>
            <span className="font-mono text-[13px] font-medium text-[var(--text-primary)] tracking-[2px]">
              {t("footer.productStatus")}
            </span>
          ...
          <div className="flex flex-col gap-4 text-center md:text-right md:items-end">
            <span className="font-mono text-[10px] text-[var(--text-subtle)] tracking-[3px]">{t("footer.connect")}</span>
            <a
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className="font-mono text-xs text-[var(--text-muted)] tracking-[2px]">{t("footer.copyright")}</span>
